			...
			try {
				...
				do {
					...
					switch (t.kind) {
						...
						case number:  System.out.println(t.val + "| string : " + t.string); break;
						case charCon: System.out.println(t.val + "| string : " + t.string); break;
						default: if(t.string != null) System.out.print(" string=\"" + t.string + '"'); System.out.println(); break;
					}
				} while (t.kind != eof);
			} catch (IOException e) {
